 ...
 * Forwards all requests to your-objectstorage-endpoint/BUCKET_NAME/uqt
 */
const http = require('http');
const https = require('https');
const url = require('url');

const BUCKET_URL = 'https://your-objectstorage-endpoint/BUCKET_NAME';
const PORT = 9001;
...
const server = http.createServer((req, res) => {
  ...
  // Build target URL - bucket structure is /BUCKET_NAME/uqt/...
