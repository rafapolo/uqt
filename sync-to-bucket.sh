...
TOTAL=$(aws s3 ls s3://BUCKET_NAME/uqt/ --endpoint-url https://your-region.your-objectstorage.com --region hel1 --recursive 2>/dev/null | wc -l)
COVERS=$(aws s3 ls s3://BUCKET_NAME/uqt/ --endpoint-url https://your-region.your-objectstorage.com --region hel1 --recursive 2>/dev/null | grep '.jpg$' | wc -l)
MP3S=$(aws s3 ls s3://BUCKET_NAME/uqt/ --endpoint-url https://your-region.your-objectstorage.com --region hel1 --recursive 2>/dev/null | grep '.mp3$' | wc -l)
...
echo "   aws s3 sync /Volumes/EXTRA/bkps/sambaderaiz/ s3://BUCKET_NAME/uqt/ \\"
