...
// Base URL for audio streaming and covers
// Points directly to Hetzner S3 bucket (zero-egress if accessed from same zone)
const BASE_URL = 'https://your-objectstorage-endpoint/BUCKET_NAME/uqt';
